...
This purpose of this project is to identify most spoken words by FB's CEO during the Senate hearing in April 10, 2018.

Web scraping
Textual data transformation and load
Wordcloud creation
...
len(p_0410_hearing[1]) # 574
len(p_0411_hearing[1]) # 599

# tokenize the hearing text
Day1 = Tokenize(p_0410_hearing[1],1)
Day2 = Tokenize(p_0411_hearing[1],2)

# draw wordclouds and frequent words plots
